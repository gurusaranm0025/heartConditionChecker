from config import CLASS_WEIGHTS, DATASET_PATH_FOR_LINUX
...
ModelDataset = TrainTestDataset(dataset_path=DATASET_PATH_FOR_LINUX,save_encoders=True, test_size=0.2, )
